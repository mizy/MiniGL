...
class Spline {
    ...
    getPoint(t) {
        ...
        const p2 = this.data[num > this.data.length - 2 ? this.data.length - 1 : this.intPoint + 1];
        const p3 = this.data[num > this.data.length - 3 ? this.data.length - 1 : this.intPoint + 2];
        return {
